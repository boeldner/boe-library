(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      try {
        ...
        // forms that are not rouched by the script
        const formsNotRouched = document.querySelectorAll('form:not([data-form-handler])');
        if (debugMode) {
            console.log('Forms not rouched by the script:', formsNotRouched.length);
        }
